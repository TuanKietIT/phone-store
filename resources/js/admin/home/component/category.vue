          ...
          <div class="flex flex-col justify-between">
              <div class="flex items-center justify-center">
                <Form @submit="createCategory" :validation-schema="schema" v-slot="{errors}" class="flex flex-col space-y-5 " >
                    <Field type="text" name="title" :class="{'is-invalid': errors.title}" class="w-[400px] focus:outline-none focus:ring is-input-start px-1 py-1 bg-gray-100 mt-10"  placeholder="Enter title"/>
        ...
        <div class="w-[500px]"> 
            <div class="bg-white">
                <Form @submit="updateCategory" :validation-schema="schema" v-slot="{errors}" class="flex flex-col space-y-5 " >
                    <Field type="text" name="title"  :class="{'is-invalid': errors.title}" class="outline-0 px-5 py-1 bg-gray-100 is-input-start mx-5 mt-10"  placeholder="Enter Title"/>
