...
<script setup>
  ...
  const getResults = (page) => {
    ...
    const token = localStorage.getItem('token');
    axios.get('/api/admin/location?page=' + page,{
        headers:{
  ...
  const createLocation = () => {
    ...
    axios.post('/api/location/create', formData,{
        headers: {
        ...
        <div class="w-2/5 bg-white ">
            <div class="flex flex-col pt-5">
                ...
                <div class="flex justify-between px-10 pt-2 ">
                    ...
                    <button type="submit" @click="createLocation" class="text-white bg-green-500 hover:bg-green-300 focus:outline-none font-medium text-sm rounded-lg px-5 py-2 text-center ml-5">Thêm</button>
                </div>
        ...
        <div class="flex w-3/5 flex-col gap-y-8">
          <div class="flex flex-col justify-between rounded-10 bg-white p-7">
            ...
            <table class="mt-4">
              ...
              <tbody>
                <tr v-for="location in Locations.data" :key="location.id" class="border-b bg-white last:border-none" >
                  <td class="py-4">
            ...
            <div class="flex items-center justify-center mt-10">
              <pagination class="" :data="Locations" v-bind:showDisabled="true" icon="chevron" v-on:change-page="getResults"></pagination>
            </div>
          </div>
        </div>
      </div>
